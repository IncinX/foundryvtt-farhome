...
test('it should fail to parse a roll formula', () => {
  const msg =
    ...
    'h, s, e, n, b, t, +, d, g, w (h = hero, s = superior, e = enhanced, n = normal, b = bad, t = terrible, + = superior defense, d = defense, g = guaranteed wound, w = wound). To roll multiple dice simply add multiple letters or prepend a number, e.g.: c3ba';
